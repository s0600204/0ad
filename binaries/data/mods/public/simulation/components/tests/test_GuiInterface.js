...
AddMock(100, IID_Player, {
	...
	GetResourceGatherers: function() { return { food: [], count: { food: 0 } } },
...
AddMock(101, IID_Player, {
	...
	GetResourceGatherers: function() { return { wood: [], count: { wood: 0 } } },
	GetPanelEntities: function() { return []; },
	IsTrainingBlocked: function() { return false; },
	GetState: function() { return "active"; },
	GetTeam: function() { return -1; },
	...
	players: [
		{
			...
			resourceGatherers: { food: [], count: { food: 0 } },
		...
		},
		{
			...
			resourceGatherers: { wood: [], count: { wood: 0 } },
			trainingBlocked: false,
			state: "active",
			team: -1,
			teamsLocked: false,
